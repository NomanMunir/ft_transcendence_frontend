    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-center">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            <img src="../../img/team/team-2.jpg" alt="" class="img-fluid" data-i18n="[alt]aboutview.teamoneImg">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            <img src="../../img/team/team-3.jpg" alt="" class="img-fluid" data-i18n="[alt]aboutview.teamtwoImg">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
          <div class="card">
            <img src="../../img/team/team-1.png" alt="" class="img-fluid" data-i18n="[alt]aboutview.teamthreeImg">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
          <div class="card">
            <img src="../../img/team/team-4.jpg" alt="" class="img-fluid" data-i18n="[alt]aboutview.teamfourImg">
            <div class="card-body">
        ...
        <div class="col-lg-3 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
          <div class="card">
            <img src="../../img/team/team-5.jpg" alt="" class="img-fluid" data-i18n="[alt]aboutview.teamfiveImg">
            <div class="card-body">
